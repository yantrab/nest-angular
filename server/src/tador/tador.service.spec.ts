    ...
    const write = (str: string) => {
        ...
        return new Promise(resolve => {
            ...
            client.connect(port, host, function() {
                ...
                client.write(new Buffer([33,56,54,49,51,49,49,48,48,57,57,56,51,54,54,56,48,50,51,54,57,48,48,48,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,77,49,32,173,169,184,165,164,32,32,163,167,32,55,84,32,32,32,32,32,32,32,32]));
                client.on('data', data => {
                    console.log(data)
                    client.end();
                    client.on('close', () => {
