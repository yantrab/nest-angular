...
@Component({
    ...
    template: `
        <p-filter [filter]="filter"></p-filter>
    `,
})
class TestHostComponent {
    ...
    constructor() {
        ...
        this.filter = new CheckboxFilter({
            options: [{ _id: '1', name: 'name1' }, { _id: '2', name: 'name2' }],
...
describe('FilterComponent', () => {
    ...
    it('should create check box', () => {
        ...
        const elcheckbox = fixture.debugElement.nativeElement.querySelector(
            'p-checkbox'
        );
        const eldropdown = fixture.debugElement.nativeElement.querySelector(
            'p-dropdown'
        );
    ...
    it('should create dropdown box', () => {
        component.filter = new DropdownFilter({
            options: [{ _id: '1', name: 'name1' }, { _id: '2', name: 'name2' }],
            selected: { _id: '2', name: 'name2' },
        });
        fixture.detectChanges();
