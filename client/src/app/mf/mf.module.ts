...
import { SpecialGridComponent } from './findFund/special-grid/special-grid.component';
import { GroupViewComponent } from './findFund/special-grid/group-view/group-view.component';
//
@NgModule({
    declarations: [
        MFComponent,
        ...
        SimulationComponent,
        FiltersComponent,
        CustomizeRankingComponent,
        SelectRankTypeComponent,
        FreelyComponent,
        ByColorComponent,
        SimpleGridComponent,
        FundCardComponent,
        CustomizeTemplateComponent,
        DefineWeightsByGroupColorsComponent,
    ...
    entryComponents: [GroupViewComponent],
