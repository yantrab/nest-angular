            ...
            merge(
                {
                    ...
                    contacts: new Contacts({
                        ...
                        contactFields: [
                            ...
                            new ContactField({ property: 'Name 2_1', title: 'שם 2_1', index: 2567, length: 12, emptySpace: 3}),
                            new ContactField({ property: 'Name 2_2', title: 'שם 2_2', index: 6567, length: 12, emptySpace: 3}),
